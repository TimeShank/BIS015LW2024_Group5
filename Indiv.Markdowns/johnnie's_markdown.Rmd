...
```{r}
endurance %>% 
  select(speed,swim_duration_in_secconds,dist_swam_in_cm)
```
...
max_journey_time_current_whale ((0.360 + 7) x 1,353.05) + ((0.360 + 32.19) x 463) = 183.84 + 14.22 = 198.06 hrs /24 = 8.3 days
```
...
journey_names <- c("journey", "self", "with_current", "with_current_whale")
```
...
They swim 1,816,053.83 meters = 1,816.052 kilometers
...
clownfish_endurance_2 %>% 
  ...
  mutate(days_to_sydney = (2922655.33 / speed_with_current) / 24)  %>%
