...
# Questions
Is it feasible for Nemo's father to travel such a distance? with the given amount of time?

What type of clownfish are Nemo and his dad?
...
jobs: find data, research data, find sources, make dataframes, clean data, make tables, plot graphs, make maps, make an app
